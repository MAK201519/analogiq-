...
export const cases: CaseRecord[] = [
  ...
  {
    slug: 'global-commercial-bank',
    client: 'A global commercial bank',
    ...
    metaTitle: 'Global bank: 12:1 ROI across six Asian markets',
    sum: 'We partnered with a global commercial bank across six Asian markets to commercialise their marketing technology investment. Twenty-four experiments doubled conversion rates on key journeys and delivered $2.6M in client lifetime value from a $210k programme spend: a 12:1 return.',
    metaDescription: 'CRO and experimentation across six Asian markets for a global commercial bank. 24 experiments, $2.6M in client lifetime value from $210k spend: 12:1 ROI.',
    stats: [
    ...
    quote: 'By highlighting the pathway to opening an account, we not only met our immediate objectives but also built a robust foundation for sustained growth.',
    quoteBy: 'A global commercial bank',
    imgs: [],
  },
  {
    slug: 'wilderness',
